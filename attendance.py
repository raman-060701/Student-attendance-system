...
class Attendance:
    def __init__(self, root):
        ...
        title_lbl = Label(self.root,text="ATTENDANCE MANAGEMENT SYSTEM", font=("Algerian", 35, "bold"), bg="white", fg="darkgreen")
        title_lbl.place(x=0, y=200, width=1590, height=45)

        main_frame=Frame(self.root,bd=2,bg="antiquewhite1",)
        main_frame.place(x=20,y=250,width=1490,height=575)
        ...
        left_inside_frame.place(x=5,y=135,width=705,height=390)
        ...
        btn_frame.place(x=5,y=300,width=690,height=35)
        ...
        export_button=Button(btn_frame,text="Export csv",command=self.exportCsv,width=18,font=("times new roman",12,"bold"),bg="blue",fg="white")
        export_button.grid(row=0,column=1)
        
        update_button=Button(btn_frame,text="Update",width=18,font=("times new roman",12,"bold"),bg="blue",fg="white")
        update_button.grid(row=0,column=2)

        reset_button=Button(btn_frame,text="Reset",command=self.reset_data,width=18,font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        table_frame.place(x=5,y=5,width=705,height=520)
