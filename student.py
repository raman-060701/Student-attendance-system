...
class Student:
    def __init__(self, root):
        ...
        #image 2
        img2 = Image.open(r"college_images\student2.jpeg")
        ...
        title_lbl = Label(bg_img, text="STUDENT MANAGEMENT SYSTEM", font=("Algerian", 35, "bold"), bg="white", fg="darkgreen")
        title_lbl.place(x=0, y=20, width=1590, height=45)

        main_frame=Frame(bg_img,bd=2,bg="white",)
        main_frame.place(x=20,y=85,width=1490,height=610)

        # left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=720,height=580)

        img_left = Image.open(r"college_images\left_label.jpeg")
        img_left = img_left.resize((705, 130), Image.ANTIALIAS)
        ...
        current_course_frame.place(x=5,y=135,width=705,height=130)
        ...
        semester_combo["values"]=("Select Semester","I","II","III","IV")
        semester_combo.current(0)
        semester_combo.grid(row=1,column=3,padx=2,pady=10,sticky=W)

        #Class student information
        class_student_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Class student information",font=("times new roman",12,"bold"))
        class_student_frame.place(x=5,y=265,width=705,height=290)
        ...
        gender_combo["values"]=("Select Geender","Male","Female","Others")
        ...
        btn_frame.place(x=10,y=200,width=680,height=30)
        ...
        #sample frame
        sample_frame=Frame(class_student_frame,bd=2,relief=RIDGE,bg="white")
        sample_frame.place(x=10,y=230,width=680,height=30)

        #photo sample button
        take_photo_sample_btn=Button(sample_frame,command=self.generate_dataset,text="Take Photo Sample",width=33,font=("times new roman",13,"bold"),bg="blue",fg="white")
        take_photo_sample_btn.grid(row=0,column=0)
        #update photo sample
        update_photo_sample_btn=Button(sample_frame,text="Update Photo Sample",width=33,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right = Image.open(r"college_images\right_label.jpeg")
        img_right = img_right.resize((705, 130), Image.ANTIALIAS)
        self.photoimg_right = ImageTk.PhotoImage(img_right)

        f_lbl1 = Label(Right_frame, image=self.photoimg_right)
        f_lbl1.place(x=5, y=0, width=705, height=130)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Ak_mishra.10",database="face_recognition")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Upadate>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="Ak_mishra.10",database="face_recognition")
                    my_cursor=conn.cursor()
                    sql_u="update student SET Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s WHERE Student_id=%s"
                    val_u=(
                                                                                                                                                                                        self.var_dep.get(),
                                                                                                                                                                                        self.var_course.get(),
                                                                                                                                                                                        self.var_year.get(),
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                for x in myresult:
                    id+=1
                sql_p="update student SET Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s WHERE Student_id=%s"
                val_p=(
                                                                                                                                                                                        self.var_dep.get(),
                                                                                                                                                                                        self.var_course.get(),
                                                                                                                                                                                        self.var_year.get(),
